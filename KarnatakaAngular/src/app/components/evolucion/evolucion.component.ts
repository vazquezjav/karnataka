...
export class EvolucionComponent implements OnInit {
  ...
  loading = false;
  // Labels
  labelYear: string = "Seleccione";
  labelMonth: string = "Todos";
  labelCluster: string = "Todos";
  labelCompany: string = "Seleccione";
  
  // Labels cards 
  labelCardLastYear:string="";
  labelCardPresentYear:string="";
  labelBrutoLast:string="";
  labelBrutoPresent:string="";
  labelBrutoPorcentLast:string="";
  labelBrutoPorcentPresent:string="";



  // radio values
  radioValue: string = "Acumulado";
  radioValueUnits: string = "Millones";
